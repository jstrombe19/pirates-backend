...
class ShipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ship" do
    assert_difference('Ship.count') do
      post ships_url, params: { ship: { captain: @ship.captain, cursed: @ship.cursed, name: @ship.name } }, as: :json
    end
  ...
  test "should update ship" do
    patch ship_url(@ship), params: { ship: { captain: @ship.captain, cursed: @ship.cursed, name: @ship.name } }, as: :json
    assert_response 200
  end
